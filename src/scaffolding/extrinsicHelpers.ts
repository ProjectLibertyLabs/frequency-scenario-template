...
export class ExtrinsicHelper {
    ...
    public static createIntent(keys: KeyringPair, payloadLocation: PayloadLocationStr, settings: IntentSettingStr[], name: string): Extrinsic {
        ...
        return new Extrinsic(
            () => ExtrinsicHelper.api.tx.schemas.createIntent(name, payloadLocationReal, settings),
            keys,
    ...
    public static createIntentGroup(keys: KeyringPair, name: string, intentIds: AnyNumber[]): Extrinsic {
        return new Extrinsic(
            () => ExtrinsicHelper.api.tx.schemas.createIntentGroup(name, intentIds),
            keys,
    ...
    public static createIntentWithSettingsGov(
        ...
        return new Extrinsic(
            () =>
                ExtrinsicHelper.api.tx.schemas.createIntentViaGovernance(
                    keys.publicKey,
                    payloadLocation,
                    settings,
                    intentName
    ...
    public static createIntentGroupGov(
        keys: KeyringPair,
    ...
    public static updateIntentGroupGov(
        keys: KeyringPair,
